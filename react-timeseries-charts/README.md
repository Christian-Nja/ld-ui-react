...
This is a patched version unlinked from the original project.
The aim is that of install this package in LD-UI react 
specifically to be integrated @Christian-Nja/ld-r demo application.
