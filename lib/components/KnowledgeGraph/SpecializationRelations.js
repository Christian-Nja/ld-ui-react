...
var SpecializationRelations = /*#__PURE__*/function (_React$Component) {
    _inherits(SpecializationRelations, _React$Component);

    var _super = _createSuper(SpecializationRelations);

    function SpecializationRelations(props) {
        var _this;

        _classCallCheck(this, SpecializationRelations);
    ...
    _createClass(SpecializationRelations, [{
        key: 'addRelations',
    ...
    return SpecializationRelations;
}(_react['default'].Component);

exports['default'] = SpecializationRelations;
