...
function PatternInstancesNetwork(props) {
    ...
    var instances = (0, _generics.defineProp)(props.patterns.instances, []); // pass this to Layout component to have a panel to switch layouts
    ...
    graph.breadthFirstSearch(filter); // effect to handle useGraphDoubleClick

    (0, _react.useEffect)(function () {
        var graph = graphRef.current.graph; // on double click trigger getInstances
