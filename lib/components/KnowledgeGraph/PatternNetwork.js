...
var _PatternGraph = _interopRequireDefault(require('./PatternGraph'));
...
function PatternNetwork(props) {
    ...
    if (props.patterns.patternSpecializations) return /*#__PURE__*/_react['default'].createElement(_reactSigma.Sigma, {
        renderer: 'webgl',
    ...
    }, /*#__PURE__*/_react['default'].createElement(_PatternGraph['default'], {
        ...
        initialSize: 15
    }), /*#__PURE__*/_react['default'].createElement(_reactSigma.RandomizeNodePositions, null));else return null;
}
/**
    ...
    try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            if (!g.nodes(subPattern)) {
                var patternLabel = extractPatternNameFromURI(subPattern);
            ...
            if (!g.nodes(superPattern)) {
                var _patternLabel = extractPatternNameFromURI(superPattern);
...
_graphology.DirectedGraph.prototype.sigmaNodes = function () {
    ...
    var _iterator2 = _createForOfIteratorHelper(this.nodeEntries()),
        _step2;
...
_graphology.DirectedGraph.prototype.sigmaEdges = function () {
    ...
    var _iterator3 = _createForOfIteratorHelper(this.edgeEntries()),
        _step3;
    ...
    try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            var _step3$value = _slicedToArray(_step3.value, 4),
                edge = _step3$value[0],
                attributes = _step3$value[1],
                source = _step3$value[2],
